...
/*	pSubSizer = new wxStaticBoxSizer(wxVERTICAL, pControls, wxT("Algorithms:"));
	...
	//Prof Yu
	//pSubSizer->Add(new wxButton(pControls, ID_SwiftCompH, wxT("Save SC file"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT), SizerFlags);
	//	pSubSizer->Add(new wxButton(pControls, ID_SwiftCompD, wxT("SC_D"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT), SizerFlags);
	pSubSizer->Add(new wxButton(pControls, ID_SwiftCompR, wxT("Run SC homogenization"), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT), SizerFlags);
	//end X
	pMainSizer->Add(pSubSizer, SizerFlags);
	SubSizers.push_back(pSubSizer);
