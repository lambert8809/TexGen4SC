...
wxWizardPageSimple* CWeaveWizard3D::BuildBinderYarnPage()
{
...

	{
		...
		wxTextCtrl* pControl;
		pSubSizer->Add(new wxStaticText(pPage, wxID_ANY, wxT("Yarn Width:")), SizerFlags);
		pSubSizer->Add(pControl = new wxTextCtrl(pPage, ID_BinderWidth, wxT("0.8"), wxDefaultPosition, wxDefaultSize, 0, wxTextValidator(wxFILTER_NUMERIC, &m_BinderWidth)), SizerFlags);
		pControl->SetToolTip(wxT("Sets the width of the binder yarns."));

		pSubSizer->Add(new wxStaticText(pPage, wxID_ANY, wxT("Yarn Height:")), SizerFlags);
		pSubSizer->Add(pControl = new wxTextCtrl(pPage, ID_BinderHeight, wxT("0.05"), wxDefaultPosition, wxDefaultSize, 0, wxTextValidator(wxFILTER_NUMERIC, &m_BinderHeight)), SizerFlags);
		pControl->SetToolTip(wxT("Sets the height of the binder yarns."));

		pSubSizer->Add(new wxStaticText(pPage, wxID_ANY, wxT("Yarn Spacing:")), SizerFlags);
		pSubSizer->Add(pControl = new wxTextCtrl(pPage, ID_BinderSpacing, wxT("0.5"), wxDefaultPosition, wxDefaultSize, 0, wxTextValidator(wxFILTER_NUMERIC, &m_BinderSpacing)), SizerFlags);
		pControl->SetToolTip(wxT("Sets the spacing in which the binder yarns are centred."));

		pSubSizer->Add(new wxStaticText(pPage, wxID_ANY, wxT("Gap size:")), SizerFlags);
		pSubSizer->Add(pControl = new wxTextCtrl(pPage, ID_GapSize, wxT("0.0"), wxDefaultPosition, wxDefaultSize, 0, wxTextValidator(wxFILTER_NUMERIC, &m_GapSize)), SizerFlags);
		pControl->SetToolTip(wxT("Sets the spacing between yarns at contact points."));
...

	{
		...
		pSubSizer->Add(new wxStaticText(pPage, wxID_ANY, wxT("Power Ellipse Section Power:")), SizerFlags);
		pSubSizer->Add(pControl = new wxTextCtrl(pPage, ID_BinderPower, wxT("0.6"), wxDefaultPosition, wxDefaultSize, 0, wxTextValidator(wxFILTER_NUMERIC, &m_BinderPower)), SizerFlags);
		pControl->SetToolTip(wxT("Sets the power for the binder yarn cross-sections."));
