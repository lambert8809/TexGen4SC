...
void CPeriodicBoundaries::OutputStep( ostream& Output, int iBoundaryConditions )
{
	...
	Output << "*** FIELD OUTPUT: Ouput Request Fy ***" << endl;
	...
	Output << "*** FIELD OUTPUT: Ouput Request Shear_xy ***" << endl;
	Output << "*Node Output, nset=ConstraintsDriver3" << endl << "U," << endl;
	if ( iBoundaryConditions == MATERIAL_CONTINUUM )
	{
		Output << "*** FIELD OUTPUT: Ouput Request Shear_yz ***" << endl;
		Output << "*Node Output, nset=ConstraintsDriver5" << endl << "U," << endl; 
		Output << "*** FIELD OUTPUT: Ouput Request Shear_zx ***" << endl;
	...
	for ( int i = 0; i < 6; ++i )
	{
		if ( iBoundaryConditions == MATERIAL_CONTINUUM || !i || i == 1 || i==3 )
